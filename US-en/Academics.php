...
$title = "Proficiencies - Badreddine Rezzouk"
?>
...
<div class="gradient-box">
    ...
    <div class="bg-white p-4 text-center rounded-3 w-50 mx-auto border border-5 shadow-lg">
        <h2> My studies, diplomas and certifications </h2>
    </div>
    <div class="box"></div>
    <div class="bg-white p-4 rounded-3 w-60 mx-auto border border-5 shadow-lg">
        <p> On this page, you will find all informations related to my studies, including where I studied, what diplomas I validated and all certifications I own. </p>
    </div>
    ...
    <div class="bg-white p-4 rounded-3 w-75 offset-1 border border-5 shadow-lg">
        ...
        <p class="text-start"><span class="text-warning">Studied at:</span>  <a class="text-dark" href="https://lyc-brassens-courcouronnes.ac-versailles.fr/">Lycée polyvalent Georges Brassens</a>, at Evry-Courcouronnes. </p>
        <div class="row">
            <div class="col-6">
            ...
            <div class="col text-center mx-auto my-auto">
                <p><span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Sciences Technologiques de l'Industrie et du Développement Durable">SIN</span> specialty, received with "Très bien" (Very good) merits.</p>
                <div class="halfbox"></div>
                <p class="text-start">Specialty subjects :</p>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseIngenieurie" aria-expanded="false" aria-controls="collapseMaths">
                                Engineering, innovation and sustainable development - Digital systems
                            </button>
                        </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseManagement" aria-expanded="false" aria-controls="collapseManagement">
                                    Management of digital systems - Agile / Ethic
                                </button>
                            </h2>
    ...
    <div class="row flex-column-reverse">
        <div class="col-10 col-md-8 text-center offset-1 flex-column-reverse bg-white p-4 rounded-3 border border-5 shadow-lg">
            <div class="row">
                <h4> My preferred pieces of software </h4>
                <div class="col">
                    <ul class="list-group list-group-flush list-group-horizontal">
                        <li class="list-group-item">
                            <figure>
