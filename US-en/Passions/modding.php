...
<div class="gradient-box">
    ...
    <div class="filters col-10 col-lg-3 offset-1 mb-2 bg-white p-4 rounded-3 border border-5 shadow-lg slideInLeft">
        ...
        <label for="categoryFilter"> Category (search): </label>
        <div class="cat-dropdown mt-2" id="catDropdown">
            <div class="tag-input mb-1" id="categoryTagInput">
                ...
                <input id="categoryFilter" class="tag-text-input" list="categoryList" placeholder="All categories" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" inputmode="search" name="category-search">
            </div>
            <datalist id="categoryList"></datalist>
            <div class="cat-menu shadow">
                <div class="cat-menu-header">
                    <strong>Categories</strong>
                    <button id="clearCategories" type="button" class="btn btn-sm btn-outline-secondary">Clear</button>
                </div>
    ...
    <script>
        ...
        function renderSelectedPills() {
            ...
            holder.innerHTML = items.map(id => {
                ...
                return `<span class="pill" data-id="${id}">${label}<button type="button" class="pill-remove" aria-label="Remove" title="Remove" data-id="${id}">×</button></span>`;
            }).join('');
