    ...
    document.addEventListener('DOMContentLoaded', () => {
        fetch('<?php echo $baseURL?>mods-json/mods.json')
            ...
            .then(data => {
                ...
                if (!mod) {
                    document.getElementById('modTitle').innerText = "Mod not found.";
                    return;
                } else {
                ...
                if (mod.download) {
                    if (mod.download.direct) {
                        downloadButtons += `<a class="btn btn-primary me-2 mb-2" href="<?php echo $topURL?>Files/Mods/${mod.download.direct}" target="_blank">⬇️ Direct Download</a>`;
                    }
                ...
                const contentHTML = `
                    <div class="row">
                        <div class="col-md-6 text-start">
                            <h5><strong>Game:</strong> ${gameName}</h5>
