...
$texts = $texts_footer[$languageFromURL] ?? $texts_footer['FR-fr'];
...
<div class="footer w-100 mx-auto py-0 my-0" >
    ...
    <div class="row bg-dark text-white mx-auto mb-0 shadow-lg">
        <div class="col"><?php echo $texts['Credits']; ?> <br>
            <a href="https://getbootstrap.com/" class="text-decoration-none text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-bootstrap" viewBox="0 0 16 16">
