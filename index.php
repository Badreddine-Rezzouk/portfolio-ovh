...
<div class="position-absolute top-0 start-0">
    ...
    <script>
        new TypeIt("#terminal", {
            ...
            .type("apt install madman badreddine-rezzouk", { lifelike:true, delay:300 }).break()
            ...
            .type('<span class="text-success">madman badreddine-rezzouk</span>', { instant:true, delay:250 }).break()
